...
export default function SyncKeyModal({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-5 bg-black/40 backdrop-blur-sm modal-overlay">
            <div className="w-full max-w-md bg-apple-bg-primary text-apple-text-primary rounded-modal shadow-2xl p-6 modal-content">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            className="mt-2 w-full rounded-xl bg-apple-bg-secondary px-4 py-3 text-note-body text-apple-text-primary outline-none ring-1 ring-transparent focus:ring-2 focus:ring-apple-accent"
                    ...
                    <div className="flex items-center justify-between gap-3">
                        {canClose ? (
                            <button
                                type="button"
                                onClick={onClose}
                                className="px-4 py-2 rounded-full text-note-caption text-apple-text-secondary hover:text-apple-text-primary transition"
                            >
                                Hủy
                            </button>
                        ) : (
                        ...
                        <button
                            type="submit"
                            className="px-6 py-2 rounded-full bg-apple-accent text-black font-semibold text-[15px] hover:bg-apple-accent-hover active:scale-95 transition"
                        >
                            Tiếp tục
                        </button>
                    </div>
